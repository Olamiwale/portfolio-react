...
export default function Home() {
  return (
    <div className="custom-bg md:pb-[200px] h-screen justify-center items-center flex">
      <div>
        <div className="md:mt-[200px] px-8 md:px-16 flex flex-col justify-center items-center">
          ...
          <p className="md:px-8 text-xl text-center lg:px-20">
            ...
            exceptional digital experience.
              ...
              <button className="bg-blue-800 text-white p-4 w-1/2 font-bold uppercase hover:bg-blue-700 rounded-lg">Contact me</button>
                </Link>
